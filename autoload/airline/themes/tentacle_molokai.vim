...
let s:cterm_green = 0        " 135
let s:gui_blue = '#87afd7'
let s:cterm_blue = 161
...
" Normal mode
let s:N1 = [s:gui_dark_gray, s:gui_green, 255, s:cterm_green]
...
let g:airline#themes#tentacle_molokai#palette.insert = {
      \ 'airline_a': [s:gui_dark_gray, s:gui_orange, 255, s:cterm_blue, ''],
      \ 'airline_c': [s:gui_red, s:gui_med_gray_hi, s:cterm_red, s:cterm_med_gray_hi, ''],
      \ }
let g:airline#themes#tentacle_molokai#palette.insert_modified = copy(g:airline#themes#angr#palette.insert_modified)
...
"let g:airline#themes#tentacle_molokai#palette.insert = airline#themes#generate_color_map(s:I1, s:N2, s:I3)
"let g:airline#themes#tentacle_molokai#palette.insert_modified = copy(g:airline#themes#angr#palette.normal_modified)
"let g:airline#themes#tentacle_molokai#palette.insert_paste = {
...
let g:airline#themes#tentacle_molokai#palette.visual = airline#themes#generate_color_map(s:V1, s:N2, s:V3)
